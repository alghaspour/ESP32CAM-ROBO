...
void setup() {
    ...
    */
    ...
    /****************************/
    /* Pins & PWM Setup for ROBO*/
    // Pin 12 & 13 for Turret 
    ...
    // Pin 15 for Motors PWM
    ledcSetup(4, 50, 8); 
    ledcAttachPin(15, 4); 

    // Set Servos in default position
    uint32_t duty = (((float(90)/180.0)
      *2000)/20000.0*65536.0) + 1634;
    // convert 0-180 degrees to 0-65536
    ledcWrite(2, duty); //Tilt
    ledcWrite(3, duty); //Pan

    ledcWrite(4, 250); // Motor PWM - ENA & ENB

    // Pins 14,2,1,3
    pinMode(14, OUTPUT); //IN1
    pinMode(2, OUTPUT);  //IN2
    pinMode(1, OUTPUT);  //IN3
